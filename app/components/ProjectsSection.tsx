...
import {featureProjects} from "@/app/const/feature-projects";
import Link from "next/link";

export const ProjectsSection = () => {
    return (
        <section id="work" className="py-12 sm:py-20 px-4 scroll-mt-20">
    ...
    <Link href={project.url} target="_blank"><h3 className="text-xl sm:text-2xl font-bold">{project.title}</h3></Link>
